...
export class AuthorsService {
    ...
    createAuthor(auhtor: Author): Observable<ResponceWrapper<Author>> {
        return this.http.post<ResponceWrapper<Author>>(`${this.baseApiUrl}`, auhtor);
    }

    updateAuthor(id: number, auhtor: Author): Observable<ResponceWrapper<Author>> {
        return this.http.put<ResponceWrapper<Author>>(`${this.baseApiUrl}/${id}`, auhtor);
    }

    deleteAuthor(id: number): Observable<ResponceWrapper<Author>> {
        return this.http.delete<ResponceWrapper<Author>>(`${this.baseApiUrl}/${id}`);
    }
}
